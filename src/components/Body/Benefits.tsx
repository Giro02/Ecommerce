  ...
  return (
    ...
    <div className="hidden sm:flex w-full max-w-[310px]">
      <div
        ...
        } w-full py-4 h-[150px] text-center md:text-left md:h-[70px] border border-color-borda px-4 rounded-xl flex flex-col md:flex-row items-center text-color-preto gap-4 mt-8`}
      >
